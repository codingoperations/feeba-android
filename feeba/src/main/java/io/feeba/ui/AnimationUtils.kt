...
object AnimationUtils {
     ...
     * drawn location
     */
    fun animateViewByTranslation(view: View, deltaFromY: Float, deltaToY: Float, duration: Int, interpolator: Interpolator?, animCallback: Animation.AnimationListener?): Animation {
     ...
     */
    fun animateViewColor(view: View, duration: Int, colorStart: Int, colorEnd: Int, animCallback: Animator.AnimatorListener?): ValueAnimator {
     ...
     */
    fun animateViewSmallToLarge(view: View, duration: Int, interpolator: Interpolator?, animCallback: Animation.AnimationListener?): Animation {
...
internal class FeebaBounceInterpolator(amplitude: Double, frequency: Double) : Interpolator {
