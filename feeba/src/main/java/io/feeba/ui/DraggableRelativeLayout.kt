    ...
    private fun createDragHelper() {
        mDragHelper = ViewDragHelper.create(this, 1.0f, object : ViewDragHelper.Callback() {
            ...
            override fun clampViewPositionVertical(child: View, top: Int, dy: Int): Int {
                ...
                lastYPos = top
                if (params!!.dragDirection == DRAGGABLE_DIRECTION_DOWN) {
                    // Dragging down
            ...
            override fun onViewReleased(releasedChild: View, xvel: Float, yvel: Float) {
                ...
                if (mDragHelper!!.settleCapturedViewAt(params!!.maxXPos, settleDestY)) ViewCompat.postInvalidateOnAnimation(this@DraggableRelativeLayout)
            }
        })
    }
